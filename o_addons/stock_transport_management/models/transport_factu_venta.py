...
class VehicleSaleOrder(models.Model):
    ...
    transportista = fields.Many2one('transport.transportista', string="Conductor", required=True)
    ...
    transport_date = fields.Date(string="Fecha de inicio del traslado", required=True)
    motivo_traslado=fields.Many2one('einvoice.catalog.20', string="Motivo del Traslado", required=True)
    modalidad_traslado=fields.Many2one('einvoice.catalog.18', string="Modalidad del Traslado", required=True)
