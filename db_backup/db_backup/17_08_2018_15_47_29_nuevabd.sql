...
<body class="container">
  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3 o_database_list">
      ...
      <div class="alert alert-danger">Database backup error: Postgres subprocess (&#39;/usr/bin/pg_dump&#39;, &#39;--no-owner&#39;, &#39;--file=/tmp/tmpi6NReW/dump.sql&#39;, u&#39;nuevabd&#39;) error 1</div>
      
      
        <div class="list-group">
          
          <a href="/web?db=kndprueba" class="list-group-item">
            kndprueba
            
            <div class="text-right pull-right">
            <span data-db="kndprueba" data-target=".o_database_backup" class="o_database_action btn-link"><i class="fa fa-floppy-o fa-fw"></i> Backup</span>
            <span data-db="kndprueba" data-target=".o_database_duplicate" class="o_database_action btn-link"><i class="fa fa-files-o fa-fw"></i> Duplicate</span>
            <span data-db="kndprueba" data-target=".o_database_delete" class="o_database_action btn-link"><i class="fa fa-trash-o fa-fw"></i> Delete</span>
            </div>
            
          </a>
          
          <a href="/web?db=nuevabd" class="list-group-item">
            nuevabd
            
            <div class="text-right pull-right">
            <span data-db="nuevabd" data-target=".o_database_backup" class="o_database_action btn-link"><i class="fa fa-floppy-o fa-fw"></i> Backup</span>
            <span data-db="nuevabd" data-target=".o_database_duplicate" class="o_database_action btn-link"><i class="fa fa-files-o fa-fw"></i> Duplicate</span>
            <span data-db="nuevabd" data-target=".o_database_delete" class="o_database_action btn-link"><i class="fa fa-trash-o fa-fw"></i> Delete</span>
            </div>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <select id="lang" name="lang" class="form-control" required="required" autocomplete="off">
              ...
              <option value="ar_SY">Arabic / الْعَرَبيّة</option>
              ...
              <option value="zh_CN">Chinese (CN) / 简体中文</option>
          
              <option value="zh_HK">Chinese (HK)</option>
          
              <option value="zh_TW">Chinese (TW) / 正體字</option>
              ...
              <option value="km_KM">Khmer / ភាសាខ្មែរ</option>
